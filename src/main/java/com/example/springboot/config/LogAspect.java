...
//            returnValue =  JSONUtil.parseObj(returnValue).getStr("code");
//        }
        // ip 和地址
        ...
        // 保存到数据库
        Log log = Log.builder().name(name).params(params).url(url).ip(ip).createTime(DateUtil.now())
    ...
    public static void main(String[] args) {
        System.out.println(IpUtils.getIPAndCity());
    }
}
